...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden">
        ...
        <nav class="flex items-center justify-end gap-4">
            ...
            <a
                href="{{ route('login') }}"
                class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] text-[#1b1b18] border-[#19140035] hover:border-[#1915014a] border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm leading-normal">
                Iniciar Sesión
            </a>
    ...
    <main id="mainID1" style="margin-bottom: 40px;" class="flex max-w-[400px] w-auto flex-col-reverse lg:max-w-3xl lg:flex-row">
  
    <h1 class="text-lg mt-2 text-4xl">GesMaq</h1>
  </div>
</main>

<main id="mainID2" style="margin-top: 40px;" class="flex max-w-[600px] flex-col-reverse lg:max-w-4xl lg:flex-row">
  <div class="text-[30px] leading-[30px] flex-1 p-6 pb-12 lg:p-40 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none flex flex-col items-start space-y-6">
